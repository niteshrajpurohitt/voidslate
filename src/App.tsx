...
export function App() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center px-2 py-3 sm:px-4 sm:py-8 select-none [perspective:1400px]">
      ...
      >
        ...
        <div className="relative rounded-lg border border-black/15 shadow-[inset_0_1px_2px_rgba(0,0,0,0.1),0_1px_0_rgba(255,255,255,0.6)] p-0.5">
          {/* Floating Screen Card (Large crisp pop forward into foreground) */}
          <motion.div
