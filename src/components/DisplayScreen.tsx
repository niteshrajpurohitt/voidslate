...
export const DisplayScreen: React.FC<DisplayScreenProps> = ({
  ...
  return (
    <div className="relative w-full max-w-full min-w-0 flex-none h-56 min-h-48 rounded-lg border border-zinc-800 bg-[linear-gradient(180deg,#101113_0%,#08090a_100%)] shadow-[0_8px_18px_rgba(0,0,0,0.32),inset_0_1px_0_rgba(255,255,255,0.1),inset_0_-8px_14px_rgba(0,0,0,0.58)] overflow-hidden select-none sm:h-72">
      ...
      <motion.textarea
        ...
        className={`w-full min-w-0 h-full p-2 text-amber-50 text-base sm:p-6 sm:text-lg md:text-xl font-semibold tracking-wide leading-relaxed resize-none outline-none border-none caret-stone-50 placeholder-zinc-400/50 relative z-0 [scrollbar-none [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden  ${
